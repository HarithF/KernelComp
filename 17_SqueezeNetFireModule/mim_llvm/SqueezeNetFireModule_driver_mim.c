...
/* Auto-generated driver for `SqueezeNetFireModule` ("mim" raw-pointer calling convention).
 ...
 *
 * Usage: SqueezeNetFireModule_driver_mim <weights> <input> <reps> <output> [run_id] [json_report]
 ...
 * timing reports.
 */
extern float *SqueezeNetFireModule(float *w1, float *b1, float *x, float *w2, float *b2, float *w3, float *b3);
...
static const size_t OUT_COUNT = 1073741824;
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "SqueezeNetFireModule_mim_llvm_%s_timing.json", run_id);
  ...
  if (use_fork) {
    ...
    if (p == 0) {
      float *out = SqueezeNetFireModule(w1, b1, x, w2, b2, w3, b3);
      free(out);
      _exit(0);
    }
  ...
  for (int i = 0; i < reps; i++) {
    ...
    if (use_fork) {
      ...
      if (p == 0) {
        ...
        float *cur = SqueezeNetFireModule(w1, b1, x, w2, b2, w3, b3);
  ...
  write_timing_report(json_report_path, "SqueezeNetFireModule", "mim_llvm", run_id,
