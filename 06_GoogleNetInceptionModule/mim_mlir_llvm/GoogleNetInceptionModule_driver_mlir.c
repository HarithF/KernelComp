 ...
 * signature, so they were borrowed from sibling .mlir (./06_GoogleNetInceptionModule/mim_mlir_llvm/GoogleNetInceptionModule_mim_mlir.mlir)
 ...
 * w1: shape [192, 480] (weight) <- branch1x1.weight @ byte 0
 * b1: shape [192] (bias) <- branch1x1.bias @ byte 368640
 * x: shape [10, 480, 224, 224] (input)
 * w2: shape [96, 480] (weight) <- branch3x3.0.weight @ byte 369408
 ...
 * w4: shape [16, 480] (weight) <- branch5x5.0.weight @ byte 1273792
 ...
 * w6: shape [64, 480] (weight) <- branch_pool.1.weight @ byte 1381568
