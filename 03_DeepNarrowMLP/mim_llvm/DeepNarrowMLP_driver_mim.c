 ...
 *
 * Usage: DeepNarrowMLP_driver_mim <weights> <input> <reps> <output> [run_id] [json_report]
 ...
 * timing reports.
 */
extern float *DeepNarrowMLP(float *w1, float *b1, float *x, float *w2, float *b2, float *w3, float *b3, float *w4, float *b4, float *w5, float *b5, float *w6, float *b6, float *w7, float *b7, float *w8, float *b8, float *w9, float *b9, float *w10, float *b10, float *w11, float *b11, float *w12, float *b12, float *w13, float *b13, float *w14, float *b14, float *w15, float *b15, float *w16, float *b16, float *w17, float *b17);
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "DeepNarrowMLP_mim_llvm_%s_timing.json", run_id);
  ...
  if (use_fork) {
    ...
    if (p == 0) {
      float *out = DeepNarrowMLP(w1, b1, x, w2, b2, w3, b3, w4, b4, w5, b5, w6, b6, w7, b7, w8, b8, w9, b9, w10, b10, w11, b11, w12, b12, w13, b13, w14, b14, w15, b15, w16, b16, w17, b17);
      free(out);
      _exit(0);
    }
  ...
  for (int i = 0; i < reps; i++) {
    ...
    if (use_fork) {
      ...
      if (p == 0) {
        ...
        float *cur = DeepNarrowMLP(w1, b1, x, w2, b2, w3, b3, w4, b4, w5, b5, w6, b6, w7, b7, w8, b8, w9, b9, w10, b10, w11, b11, w12, b12, w13, b13, w14, b14, w15, b15, w16, b16, w17, b17);
  ...
  write_timing_report(json_report_path, "DeepNarrowMLP", "mim_llvm", run_id,
