 ...
 * signature, so they were borrowed from sibling .mlir (./25_ShuffleNetUnit/mim_mlir_llvm/ShuffleNetUnit_mim_mlir.mlir)
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "ShuffleNetUnit_mim_mlir_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "ShuffleNetUnit", "mim_mlir_llvm", run_id,
