 ...
 *
 * Usage: AlexNet_driver_mim <weights> <input> <reps> <output> [run_id] [json_report]
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "AlexNet_mim_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "AlexNet", "mim_llvm", run_id,
