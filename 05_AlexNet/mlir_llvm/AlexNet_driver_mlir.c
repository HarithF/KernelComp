 ...
 * signature, so they were borrowed from sibling .mlir (./05_AlexNet/mlir_llvm/AlexNet_mlir.mlir)
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "AlexNet_mlir_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "AlexNet", "mlir_llvm", run_id,
