 ...
 * signature, so they were borrowed from sibling .mlir (./07_GoogleNetInceptionV1/mlir_llvm/GoogleNetInceptionV1_mlir.mlir)
 ...
 * w2: shape [64, 64, 1, 1] (weight) <- conv2.weight @ byte 37888
 ...
 * w4: shape [64, 192, 1, 1] (weight) <- inception3a.branch1x1.weight @ byte 497664
 * b4: shape [64] (bias) <- inception3a.branch1x1.bias @ byte 546816
 * w5: shape [96, 192, 1, 1] (weight) <- inception3a.branch3x3.0.weight @ byte 547072
 ...
 * w7: shape [16, 192, 1, 1] (weight) <- inception3a.branch5x5.0.weight @ byte 1064064
 ...
 * w9: shape [32, 192, 1, 1] (weight) <- inception3a.branch_pool.1.weight @ byte 1127744
 * b9: shape [32] (bias) <- inception3a.branch_pool.1.bias @ byte 1152320
 * w10: shape [128, 256, 1, 1] (weight) <- inception3b.branch1x1.weight @ byte 1152448
 * b10: shape [128] (bias) <- inception3b.branch1x1.bias @ byte 1283520
 * w11: shape [128, 256, 1, 1] (weight) <- inception3b.branch3x3.0.weight @ byte 1284032
 ...
 * w13: shape [32, 256, 1, 1] (weight) <- inception3b.branch5x5.0.weight @ byte 2301120
 ...
 * w15: shape [64, 256, 1, 1] (weight) <- inception3b.branch_pool.1.weight @ byte 2641600
 * b15: shape [64] (bias) <- inception3b.branch_pool.1.bias @ byte 2707136
 * w16: shape [192, 480, 1, 1] (weight) <- inception4a.branch1x1.weight @ byte 2707392
 * b16: shape [192] (bias) <- inception4a.branch1x1.bias @ byte 3076032
 * w17: shape [96, 480, 1, 1] (weight) <- inception4a.branch3x3.0.weight @ byte 3076800
 ...
 * w19: shape [16, 480, 1, 1] (weight) <- inception4a.branch5x5.0.weight @ byte 3981184
 ...
 * w21: shape [64, 480, 1, 1] (weight) <- inception4a.branch_pool.1.weight @ byte 4088960
 * b21: shape [64] (bias) <- inception4a.branch_pool.1.bias @ byte 4211840
 * w22: shape [160, 512, 1, 1] (weight) <- inception4b.branch1x1.weight @ byte 4212096
 * b22: shape [160] (bias) <- inception4b.branch1x1.bias @ byte 4539776
 * w23: shape [112, 512, 1, 1] (weight) <- inception4b.branch3x3.0.weight @ byte 4540416
 ...
 * w25: shape [24, 512, 1, 1] (weight) <- inception4b.branch5x5.0.weight @ byte 5674304
 ...
 * w27: shape [64, 512, 1, 1] (weight) <- inception4b.branch_pool.1.weight @ byte 5877408
 * b27: shape [64] (bias) <- inception4b.branch_pool.1.bias @ byte 6008480
 * w28: shape [128, 512, 1, 1] (weight) <- inception4c.branch1x1.weight @ byte 6008736
 * b28: shape [128] (bias) <- inception4c.branch1x1.bias @ byte 6270880
 * w29: shape [128, 512, 1, 1] (weight) <- inception4c.branch3x3.0.weight @ byte 6271392
 ...
 * w31: shape [24, 512, 1, 1] (weight) <- inception4c.branch5x5.0.weight @ byte 7714720
 ...
 * w33: shape [64, 512, 1, 1] (weight) <- inception4c.branch_pool.1.weight @ byte 7917824
 * b33: shape [64] (bias) <- inception4c.branch_pool.1.bias @ byte 8048896
 * w34: shape [112, 512, 1, 1] (weight) <- inception4d.branch1x1.weight @ byte 8049152
 * b34: shape [112] (bias) <- inception4d.branch1x1.bias @ byte 8278528
 * w35: shape [144, 512, 1, 1] (weight) <- inception4d.branch3x3.0.weight @ byte 8278976
 ...
 * w37: shape [32, 512, 1, 1] (weight) <- inception4d.branch5x5.0.weight @ byte 10068608
 ...
 * w39: shape [64, 512, 1, 1] (weight) <- inception4d.branch_pool.1.weight @ byte 10339328
 * b39: shape [64] (bias) <- inception4d.branch_pool.1.bias @ byte 10470400
 * w40: shape [256, 528, 1, 1] (weight) <- inception4e.branch1x1.weight @ byte 10470656
 * b40: shape [256] (bias) <- inception4e.branch1x1.bias @ byte 11011328
 * w41: shape [160, 528, 1, 1] (weight) <- inception4e.branch3x3.0.weight @ byte 11012352
 ...
 * w43: shape [32, 528, 1, 1] (weight) <- inception4e.branch5x5.0.weight @ byte 13195392
 ...
 * w45: shape [128, 528, 1, 1] (weight) <- inception4e.branch_pool.1.weight @ byte 13673216
 * b45: shape [128] (bias) <- inception4e.branch_pool.1.bias @ byte 13943552
 * w46: shape [256, 832, 1, 1] (weight) <- inception5a.branch1x1.weight @ byte 13944064
 * b46: shape [256] (bias) <- inception5a.branch1x1.bias @ byte 14796032
 * w47: shape [160, 832, 1, 1] (weight) <- inception5a.branch3x3.0.weight @ byte 14797056
 ...
 * w49: shape [32, 832, 1, 1] (weight) <- inception5a.branch5x5.0.weight @ byte 17174656
 ...
 * w51: shape [128, 832, 1, 1] (weight) <- inception5a.branch_pool.1.weight @ byte 17691392
 * b51: shape [128] (bias) <- inception5a.branch_pool.1.bias @ byte 18117376
 * w52: shape [384, 832, 1, 1] (weight) <- inception5b.branch1x1.weight @ byte 18117888
 * b52: shape [384] (bias) <- inception5b.branch1x1.bias @ byte 19395840
 * w53: shape [192, 832, 1, 1] (weight) <- inception5b.branch3x3.0.weight @ byte 19397376
 ...
 * w55: shape [48, 832, 1, 1] (weight) <- inception5b.branch5x5.0.weight @ byte 22692864
 ...
 * w57: shape [128, 832, 1, 1] (weight) <- inception5b.branch_pool.1.weight @ byte 23467712
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "GoogleNetInceptionV1_mlir_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "GoogleNetInceptionV1", "mlir_llvm", run_id,
