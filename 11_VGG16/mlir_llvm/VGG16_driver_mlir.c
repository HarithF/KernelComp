 ...
 * signature, so they were borrowed from sibling .mlir (./11_VGG16/mlir_llvm/VGG16_mlir.mlir)
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "VGG16_mlir_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "VGG16", "mlir_llvm", run_id,
