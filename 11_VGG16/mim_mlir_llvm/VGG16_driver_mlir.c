...
/* Auto-generated driver for `VGG16` matching MLIR's expanded memref
 ...
 * signature, so they were borrowed from sibling .mlir (./11_VGG16/mim_mlir_llvm/VGG16_mim_mlir.mlir)
 ...
 * in weights.bin is its byte offset from VGG16_params.json,
 ...
 *
 * Usage: VGG16_driver_mlir <weights> <input> <reps> <output> [run_id] [json_report]
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "VGG16_mim_mlir_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "VGG16", "mim_mlir_llvm", run_id,
