...
module {
  func.func @NetVladWithGhostClusters(%arg0: tensor<2048x100x512xf32>, %arg1: tensor<512x48xf32>, %arg2: tensor<1x512x32xf32>, %arg3: tensor<48xf32>, %arg4: tensor<48xf32>, %arg5: tensor<48xf32>, %arg6: tensor<48xf32>) -> tensor<2048x16384xf32> {
    ...
    %0 = tensor.empty() : tensor<204800x48xf32>
    %1 = linalg.fill ins(%cst : f32) outs(%0 : tensor<204800x48xf32>) -> tensor<204800x48xf32>
    %2 = linalg.matmul ins(%collapsed, %arg1 : tensor<204800x512xf32>, tensor<512x48xf32>) outs(%1 : tensor<204800x48xf32>) -> tensor<204800x48xf32>
    %3 = tensor.empty() : tensor<48xf32>
    %4 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins(%arg6 : tensor<48xf32>) outs(%3 : tensor<48xf32>) {
    ^bb0(%in: f32, %out: f32):
      %44 = arith.truncf %cst_2 : f64 to f32
      %45 = arith.addf %in, %44 : f32
      linalg.yield %45 : f32
    } -> tensor<48xf32>
    %5 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins(%4 : tensor<48xf32>) outs(%3 : tensor<48xf32>) {
    ^bb0(%in: f32, %out: f32):
      %44 = math.rsqrt %in : f32
      linalg.yield %44 : f32
    } -> tensor<48xf32>
    %6 = linalg.generic {indexing_maps = [#map1, #map2, #map1], iterator_types = ["parallel", "parallel"]} ins(%2, %arg5 : tensor<204800x48xf32>, tensor<48xf32>) outs(%0 : tensor<204800x48xf32>) {
    ^bb0(%in: f32, %in_10: f32, %out: f32):
      %44 = arith.subf %in, %in_10 : f32
      linalg.yield %44 : f32
    } -> tensor<204800x48xf32>
    %7 = linalg.generic {indexing_maps = [#map1, #map2, #map1], iterator_types = ["parallel", "parallel"]} ins(%6, %5 : tensor<204800x48xf32>, tensor<48xf32>) outs(%0 : tensor<204800x48xf32>) {
    ^bb0(%in: f32, %in_10: f32, %out: f32):
      %44 = arith.mulf %in, %in_10 : f32
      linalg.yield %44 : f32
    } -> tensor<204800x48xf32>
    %8 = linalg.generic {indexing_maps = [#map1, #map2, #map1], iterator_types = ["parallel", "parallel"]} ins(%7, %arg3 : tensor<204800x48xf32>, tensor<48xf32>) outs(%0 : tensor<204800x48xf32>) {
    ^bb0(%in: f32, %in_10: f32, %out: f32):
      %44 = arith.mulf %in, %in_10 : f32
      linalg.yield %44 : f32
    } -> tensor<204800x48xf32>
    %9 = linalg.generic {indexing_maps = [#map1, #map2, #map1], iterator_types = ["parallel", "parallel"]} ins(%8, %arg4 : tensor<204800x48xf32>, tensor<48xf32>) outs(%0 : tensor<204800x48xf32>) {
    ^bb0(%in: f32, %in_10: f32, %out: f32):
    ...
    %14:2 = linalg.generic {indexing_maps = [#map1, #map3, #map3], iterator_types = ["parallel", "reduction"]} ins(%9 : tensor<204800x48xf32>) outs(%13, %11 : tensor<204800xf32>, tensor<204800xi64>) {
    ...
    %15 = linalg.generic {indexing_maps = [#map1, #map4, #map1], iterator_types = ["parallel", "parallel"]} ins(%9, %expanded : tensor<204800x48xf32>, tensor<204800x1xf32>) outs(%0 : tensor<204800x48xf32>) {
    ^bb0(%in: f32, %in_10: f32, %out: f32):
      %44 = arith.subf %in, %in_10 : f32
      linalg.yield %44 : f32
    } -> tensor<204800x48xf32>
    %16 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%15 : tensor<204800x48xf32>) outs(%0 : tensor<204800x48xf32>) {
    ^bb0(%in: f32, %out: f32):
      %44 = math.exp %in : f32
      linalg.yield %44 : f32
    } -> tensor<204800x48xf32>
    ...
    %19 = linalg.generic {indexing_maps = [#map1, #map4], iterator_types = ["parallel", "reduction"]} ins(%16 : tensor<204800x48xf32>) outs(%18 : tensor<204800x1xf32>) {
    ^bb0(%in: f32, %out: f32):
      %44 = arith.addf %in, %out : f32
      linalg.yield %44 : f32
    } -> tensor<204800x1xf32>
    %20 = linalg.generic {indexing_maps = [#map1, #map4, #map1], iterator_types = ["parallel", "parallel"]} ins(%16, %19 : tensor<204800x48xf32>, tensor<204800x1xf32>) outs(%0 : tensor<204800x48xf32>) {
    ^bb0(%in: f32, %in_10: f32, %out: f32):
      %44 = arith.divf %in, %in_10 : f32
      linalg.yield %44 : f32
    } -> tensor<204800x48xf32>
    %extracted_slice = tensor.extract_slice %20[0, 0] [204800, 32] [1, 1] : tensor<204800x48xf32> to tensor<204800x32xf32>
    %expanded_5 = tensor.expand_shape %extracted_slice [[0, 1], [2]] output_shape [2048, 100, 32] : tensor<204800x32xf32> into tensor<2048x100x32xf32>
