...
110:                                              ; preds = %95
  %111 = call ptr @aligned_alloc(i64 64, i64 16777216)
  ...
  %116 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %115, i64 32768, 3, 1
  %117 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %116, i64 32768, 4, 0
...
141:                                              ; preds = %138
  ...
  %192 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %191, i64 32768, 4, 0
...
291:                                              ; preds = %248
  %292 = call ptr @aligned_alloc(i64 64, i64 8388608)
  ...
  %297 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %296, i64 16384, 3, 1
  %298 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %297, i64 16384, 4, 0
