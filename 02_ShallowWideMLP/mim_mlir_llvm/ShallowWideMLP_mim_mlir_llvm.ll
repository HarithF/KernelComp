...
237:                                              ; preds = %178
  %238 = call ptr @malloc(i64 131136)
  ...
  %248 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %247, i64 32768, 3, 1
  %249 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %248, i64 32768, 4, 0
...
283:                                              ; preds = %251
  %284 = call ptr @malloc(i64 16777280)
  ...
  %294 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %293, i64 32768, 3, 1
  %295 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %294, i64 32768, 4, 0
...
330:                                              ; preds = %297
  %331 = call ptr @malloc(i64 16777280)
  ...
  %341 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %340, i64 32768, 3, 1
  %342 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %341, i64 32768, 4, 0
...
384:                                              ; preds = %344
  %385 = call ptr @malloc(i64 16777280)
  ...
  %395 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %394, i64 32768, 3, 1
  %396 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %395, i64 32768, 4, 0
...
433:                                              ; preds = %398
  %434 = call ptr @malloc(i64 4294967360)
  ...
  %443 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %442, i64 32768, 3, 0
  %444 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %443, i64 32768, 3, 1
  %445 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %444, i64 32768, 4, 0
  %446 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %445, i64 1, 4, 1
  br label %447

447:                                              ; preds = %479, %433
  %448 = phi i64 [ %480, %479 ], [ 0, %433 ]
  %449 = icmp slt i64 %448, 32768
...
481:                                              ; preds = %447
  %482 = call ptr @malloc(i64 16777280)
  ...
  %492 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %491, i64 32768, 3, 1
  %493 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %492, i64 32768, 4, 0
...
584:                                              ; preds = %525
  %585 = call ptr @malloc(i64 131136)
  ...
  %595 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %594, i64 32768, 3, 1
  %596 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %595, i64 32768, 4, 0
...
630:                                              ; preds = %598
  %631 = call ptr @malloc(i64 16777280)
  ...
  %641 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %640, i64 32768, 3, 1
  %642 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %641, i64 32768, 4, 0
...
677:                                              ; preds = %644
  %678 = call ptr @malloc(i64 16777280)
  ...
  %688 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %687, i64 32768, 3, 1
  %689 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %688, i64 32768, 4, 0
...
731:                                              ; preds = %691
  %732 = call ptr @malloc(i64 16777280)
  ...
  %742 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %741, i64 32768, 3, 1
  %743 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %742, i64 32768, 4, 0
...
780:                                              ; preds = %745
  %781 = call ptr @malloc(i64 2147483712)
  ...
  %790 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %789, i64 32768, 3, 0
  %791 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %790, i64 16384, 3, 1
  %792 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %791, i64 16384, 4, 0
  %793 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %792, i64 1, 4, 1
  br label %794

794:                                              ; preds = %826, %780
  %795 = phi i64 [ %827, %826 ], [ 0, %780 ]
  %796 = icmp slt i64 %795, 32768
...
828:                                              ; preds = %794
  %829 = call ptr @malloc(i64 8388672)
  ...
  %839 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %838, i64 16384, 3, 1
  %840 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %839, i64 16384, 4, 0
...
931:                                              ; preds = %872
  ...
  %942 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %941, i64 16384, 3, 1
  %943 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %942, i64 16384, 4, 0
...
977:                                              ; preds = %945
  %978 = call ptr @malloc(i64 8388672)
  ...
  %988 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %987, i64 16384, 3, 1
  %989 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %988, i64 16384, 4, 0
...
1008:                                             ; preds = %1005
  ...
  %1014 = mul nuw nsw i64 %1001, 16384
...
1024:                                             ; preds = %991
  %1025 = call ptr @malloc(i64 8388672)
  ...
  %1035 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %1034, i64 16384, 3, 1
  %1036 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %1035, i64 16384, 4, 0
...
1055:                                             ; preds = %1052
  ...
  %1057 = mul nuw nsw i64 %1048, 16384
  ...
  %1062 = mul nuw nsw i64 %1048, 16384
  ...
  %1068 = mul nuw nsw i64 %1048, 16384
