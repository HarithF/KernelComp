 ...
 * signature, so they were borrowed from sibling .mlir (./12_VGG19/mlir_llvm/VGG19_mlir.mlir),
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "VGG19_mlir_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "VGG19", "mlir_llvm", run_id,
