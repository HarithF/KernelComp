...
378:                                              ; preds = %375
  ...
  %385 = srem i64 %384, 4096
  %386 = icmp slt i64 %385, 0
  %387 = add i64 %385, 4096
  ...
  %404 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %403, i64 32768, 4, 0
  %405 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %404, i64 2, 3, 1
  %406 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %405, i64 16384, 4, 1
  ...
  %441 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %440, i64 32768, 4, 0
  %442 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %441, i64 2, 3, 1
  %443 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %442, i64 16384, 4, 1
...
467:                                              ; preds = %464
  ...
  %474 = srem i64 %473, 4096
  %475 = icmp slt i64 %474, 0
  %476 = add i64 %474, 4096
  ...
  %485 = mul nuw nsw i64 %449, 32768
  %486 = mul nuw nsw i64 %457, 16384
  ...
  %505 = mul nuw nsw i64 %449, 32768
  %506 = mul nuw nsw i64 %457, 16384
  ...
  %518 = mul nuw nsw i64 %449, 32768
  %519 = mul nuw nsw i64 %457, 16384
...
556:                                              ; preds = %553
  ...
  %558 = mul nuw nsw i64 %542, 32768
  %559 = mul nuw nsw i64 %546, 16384
  ...
  %574 = mul nuw nsw i64 %542, 32768
  %575 = mul nuw nsw i64 %546, 16384
...
588:                                              ; preds = %541
  %589 = call ptr @aligned_alloc(i64 64, i64 4194304)
  ...
  %595 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %594, i64 2048, 3, 2
  %596 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %595, i64 4, 3, 3
  %597 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %596, i64 16384, 4, 0
  %598 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %597, i64 8192, 4, 1
  %599 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %598, i64 4, 4, 2
  %600 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %599, i64 1, 4, 3
  %601 = call ptr @aligned_alloc(i64 64, i64 4194304)
  ...
  %607 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %606, i64 2048, 3, 2
  %608 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %607, i64 4, 3, 3
  %609 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %608, i64 16384, 4, 0
  %610 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %609, i64 8192, 4, 1
...
628:                                              ; preds = %625
  ...
  %630 = mul nuw nsw i64 %614, 16384
  %631 = mul nuw nsw i64 %618, 8192
...
656:                                              ; preds = %653
  ...
  %663 = srem i64 %662, 4096
  %664 = icmp slt i64 %663, 0
  %665 = add i64 %663, 4096
  ...
  %682 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %681, i64 32768, 4, 0
  %683 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %682, i64 2, 3, 1
  %684 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %683, i64 16384, 4, 1
  ...
  %719 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %718, i64 16384, 4, 0
  %720 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %719, i64 2, 3, 1
  %721 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %720, i64 8192, 4, 1
...
745:                                              ; preds = %742
  ...
  %752 = srem i64 %751, 4096
  %753 = icmp slt i64 %752, 0
  %754 = add i64 %752, 4096
  ...
  %763 = mul nuw nsw i64 %727, 32768
  %764 = mul nuw nsw i64 %735, 16384
  ...
  %783 = mul nuw nsw i64 %727, 16384
  %784 = mul nuw nsw i64 %735, 8192
  ...
  %796 = mul nuw nsw i64 %727, 16384
  %797 = mul nuw nsw i64 %735, 8192
...
834:                                              ; preds = %831
  ...
  %836 = mul nuw nsw i64 %820, 16384
  %837 = mul nuw nsw i64 %824, 8192
  ...
  %851 = mul nuw nsw i64 %820, 16384
  %852 = mul nuw nsw i64 %824, 8192
...
865:                                              ; preds = %819
  %866 = call ptr @aligned_alloc(i64 64, i64 4194304)
  ...
  %871 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %870, i64 8192, 3, 1
  %872 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %871, i64 8192, 4, 0
...
881:                                              ; preds = %878
  ...
  %898 = srem i64 %897, 2048
  %899 = icmp slt i64 %898, 0
  %900 = add i64 %898, 2048
  ...
  %907 = mul nuw nsw i64 %887, 16384
  %908 = mul nuw nsw i64 %891, 8192
