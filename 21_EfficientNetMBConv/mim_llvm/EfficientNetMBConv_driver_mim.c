...
/* Auto-generated driver for `EfficientNetMBConv` ("mim" raw-pointer calling convention).
 ...
 *
 * Usage: EfficientNetMBConv_driver_mim <weights> <input> <reps> <output> [run_id] [json_report]
 ...
 * timing reports.
 */
extern float *EfficientNetMBConv(float *w1, float *x, float *b1, float *b2, float *b3, float *b4, float *w2, float *b5, float *b6, float *b7, float *b8, float *w3, float *b9, float *b10, float *b11, float *b12);
...
static const size_t OUT_COUNT = 24084480;
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "EfficientNetMBConv_mim_llvm_%s_timing.json", run_id);
  ...
  if (use_fork) {
    ...
    if (p == 0) {
      float *out = EfficientNetMBConv(w1, x, b1, b2, b3, b4, w2, b5, b6, b7, b8, w3, b9, b10, b11, b12);
      free(out);
      _exit(0);
    }
  ...
  for (int i = 0; i < reps; i++) {
    ...
    if (use_fork) {
      ...
      if (p == 0) {
        ...
        float *cur = EfficientNetMBConv(w1, x, b1, b2, b3, b4, w2, b5, b6, b7, b8, w3, b9, b10, b11, b12);
  ...
  write_timing_report(json_report_path, "EfficientNetMBConv", "mim_llvm", run_id,
