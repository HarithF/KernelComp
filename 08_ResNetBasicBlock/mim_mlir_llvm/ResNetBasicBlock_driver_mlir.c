 ...
 * signature, so they were borrowed from sibling .mlir (./08_ResNetBasicBlock/mim_mlir_llvm/ResNetBasicBlock_mim_mlir.mlir)
...
int main(int argc, char **argv) {
  ...
  if (argc > 6) {
    ...
    snprintf(json_path_buf, sizeof(json_path_buf), "ResNetBasicBlock_mim_mlir_llvm_%s_timing.json", run_id);
  ...
  write_timing_report(json_report_path, "ResNetBasicBlock", "mim_mlir_llvm", run_id,
